            ...
            <div className="posts">
                {isLoading ? (
                    ...
                    {posts && posts.length > 0 ? (
                                ...
                                <div className="post" key={post.id}>
                                    ...
                                    <div className="postright">
                                        ...
                                        <div className="post_bottom">
                                            ...
                                            <div className="like" onClick={likeToggle} data-post_id={post.id}>
                                                {post.liked ? (
                                            ...
                                            <div className="save">
                                                {post.bookmarked ? (
                                                    <svg style={{fill: 'dodgerblue'}} viewBox="0 0 24 24" aria-hidden="true" className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-50lct3 r-1srniue"><g><path d="M4 4.5C4 3.12 5.119 2 6.5 2h11C18.881 2 20 3.12 20 4.5v18.44l-8-5.71-8 5.71V4.5z"></path></g></svg>
                                                ):(
                        ...
                        <label style={{width: '100%', textAlign: 'center'}}>No posts from this user</label>
                    )}
