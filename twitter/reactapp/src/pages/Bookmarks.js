...
import ReactMarkdown from "react-markdown-renderer";
import gfm from 'remark-gfm';


export default function Bookmarks({ userdata }){
    const [posts, setPosts] = useState([]);
    const [isLoading, setIsLoading] = useState(true);

    useEffect(() => {
        fetch('http://localhost:8000/api/bookmark_posts/', {
                method: 'GET', 
                credentials: 'include',
            })
            .then(response => {
                    ...
                    <Left userdata={userdata} />
                        <div className="center">
                            <div className="centerinner">
                                ...
                                <div className="messagecon" style={{marginTop: '15px'}}>
                                    {posts && posts.length > 0 ? (
                                                ...
                                                <div className="post" key={post.id}>
                                                    ...
                                                    <div className="postright">
                                                        ...
                                                        <div className="post_bottom">
                                                            ...
                                                            <div className="save">
                                                                {post.bookmarked ? (
                                                                    <svg style={{fill: 'dodgerblue'}} viewBox="0 0 24 24" aria-hidden="true" className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1xvli5t r-1hdv0qi"><g><path d="M4 4.5C4 3.12 5.119 2 6.5 2h11C18.881 2 20 3.12 20 4.5v18.44l-8-5.71-8 5.71V4.5z"></path></g></svg>
                                                                ):(
                                        ...
                                        <div className="no" style={{height: '10vh'}}>
                                            <h2>Save posts for later</h2>
                                            <label>Bookmark posts to easily find them again in the future.</label>
                                        </div>
                                    )}
